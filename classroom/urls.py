...
urlpatterns = [
	...
	path('reviewers/home/projects/<int:pk>/', reviewers.ProjectView.as_view(), name='project_page'),
	...
	path('classroom/courses/course/myproject/submit_report/', students.SubmitReport, name='submit_report'),
	path('classroom/courses/course/myproject/upload_report/', students.SubmitReport, name='upload_report'),
	...
	path('classroom/mycourses/course/submitted_projects/<int:pk>/', teachers.ViewProjectView.as_view(), name='view_project'),
